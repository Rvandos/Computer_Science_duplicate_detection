...
train_sig_matrix = pd.read_csv('Signature_matrix_train_bootstrap1.csv')
train_sig_matrix = train_sig_matrix.drop('Unnamed: 0', axis=1).to_numpy()

with open('train_data_bootstrap1.json', 'r') as f:
...
print(functions.get_bandrow(train_sig_matrix, 40, 1000))
#LSH part
